...
import { getTypes, updateBackup } from "../../redux/actions/pokeActions";
...
export function Create(props) {
    ...
    function postPokemon(e) {
        ...
        // props.dispatchUpdateBackup(newPokemon)
    }
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        // dispatchUpdateBackup: (newPoke) => dispatch(updateBackup(newPoke))
    }
}
